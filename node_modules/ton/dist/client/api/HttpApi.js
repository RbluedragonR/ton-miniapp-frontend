...
class HttpApi {
    constructor(endpoint, cache, parameters) {
        ...
        this.cache = cache;
        this.parameters = {
            timeout: (parameters === null || parameters === void 0 ? void 0 : parameters.timeout) || 30000, // 30 seconds by default
        };
        // Shard
    ...
    async doCall(method, body, codec) {
        let res = await (0, teslabot_1.asyncTimeout)((0, isomorphic_unfetch_1.default)(this.endpoint, {
            method: 'POST',
            headers: {
