...
async function createWalletTransferV1(args) {
    ...
    let signature = (0, ton_crypto_1.sign)(await cell.hash(), args.secretKey);
    // Body
...
async function createWalletTransferV2(args) {
...
async function createWalletTransferV3(args) {
